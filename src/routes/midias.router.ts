...
import {
  atualizarMidiaController,
  deletarMidiaController,
  listarTodasMidiasController,
  listarUnicaMidiaController,
  registrarMidiaController,
} from "../controllers/midias.controller";
